...
<div id="dodavanje">
  <form role="form" action="upload.php" method="post" enctype="multipart/form-data">
   ...
   <div class="form-group">
	 <label for="stanje">Izaberi stanje na lageru:</label><br>
  <select id="stanje" name="stanje" style="width:100%;color:black;padding:10px;"> 
<option value="ima" style="color:green">IMA NA LAGERU</option>
<option value="nema" style="color:red">NEMA NA LAGERU</option>
</select>
 </div>
 -->
 <div class="form-group">
