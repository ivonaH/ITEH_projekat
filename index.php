...
<form method="post" >
<h5 style="color:white">Korisnicko ime</h5>
<input type="text" id="korisnickoime" placeholder="Korisničko ime" name="korisnickoime" style="background:none; color:white">
<br>
<h5 style="color:white">Sifra</h5>
<input type="password" placeholder="Šifra" name="sifra" style="background:none; color:white">
<br><br>
