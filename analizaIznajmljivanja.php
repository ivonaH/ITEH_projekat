...
header("Content-type: application/json");?>
    ...
    $array['cols'][] = array('label' => 'Broj pasa', 'type' => 'number');
 
$sql="SELECT korisnik,count(rezervacijaId) AS 'ukupno' FROM rezervacija r INNER JOIN pas p ON (p.pasId=r.pasId) GROUP BY korisnik";
